    ...
    function GAME(ran) {
        ...
        for (i = 0; i < aData.length; i++) {
            ...
            /*
                imgPath === 0/1/2 
            */
            oLi.style.backgroundImage = 'url(' + config.imgPath + 'images/girl' + imgPath + '/girl.png)';
            oLi.style.backgroundPosition = '-' + col * 82 + 'px -' + row * 190 + 'px';
            oLi.setAttribute('data-index', aData[i]);
            oFragment.appendChild(oLi)
        }
        oBox.appendChild(oFragment);
        oBox.style.background = "url(" + config.imgPath + "images/girl" + imgPath + "/bg.png)  no-repeat";
